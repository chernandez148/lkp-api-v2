...
from app.api.v1.endpoints import auth, products, reviews, users, orders, favorites, stripe
...
api_router.include_router(stripe.router, prefix="/stripe", tags=["stripe"], dependencies=[Depends(get_current_user)])
